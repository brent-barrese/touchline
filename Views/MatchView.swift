...
//                    match.pausedAt = nil
//
//                    // Players on field start counting from kickoff
...
//            .autoconnect()
//            .sink { newTime in
//                if match.hasStartedPlay && !match.isEnded && !match.isPaused {
//                    now = newTime
//                }
//            }
//    }
...
//                let effectiveEnd = match.effectiveNow(at: end)
